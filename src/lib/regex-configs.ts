...
export const REGEX_LIST_BLOCKS =
  /^(•)([0-9]+[iI]*|[a-zA-Z]{1}|_|\+|-|)([^\S\r\n]+)/; // ++BODY: $6^$7$8
...
export const UNBREAKSCAPE_PLAIN_IN_BODY_REGEX = new RegExp(
  '^(\\[)\\^(\\^*)(\\.)',
  'gm'
);
